...
TEST(Integration, SubstNth) { EXPECT_EQ(run_sed("s/a/X/2", "aaa\n"), "aXa\n"); }
...
TEST(Integration, DeleteFirst) { EXPECT_EQ(run_sed("1d", "a\nb\n"), "b\n"); }

TEST(Integration, DeleteLast) { EXPECT_EQ(run_sed("$d", "a\nb\n"), "a\n"); }

TEST(Integration, DeleteAll) { EXPECT_EQ(run_sed("d", "a\nb\n"), ""); }
...
// ── Empty input ───────────────────────────────────────────────
TEST(Integration, EmptyInput) { EXPECT_EQ(run_sed("s/a/b/", ""), ""); }
