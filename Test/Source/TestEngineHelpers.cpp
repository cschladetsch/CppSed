...
TEST(DoTrans, IdentityMapping) {
    EXPECT_EQ(trans("abc", "abc", "abc"), "abc");
}

TEST(DoTrans, SimpleUppercase) {
    EXPECT_EQ(trans("abcdefghijklmnopqrstuvwxyz",
...
TEST(DoTrans, EmptyInput) {
    EXPECT_EQ(trans("abc", "ABC", ""), "");
}

TEST(DoTrans, NewlineMapped) {
    EXPECT_EQ(trans("\n", "X", "a\nb"), "aXb");
}

TEST(DoTrans, CharMappedToItself) {
    EXPECT_EQ(trans("a", "a", "aaa"), "aaa");
}
...
TEST(DoList, EmptyInput) {
    EXPECT_EQ(list_output(""), "$\n");
}
...
TEST(DoList, EscapesTab) {
    EXPECT_EQ(list_output("\t"), "\\t$\n");
}

TEST(DoList, EscapesNewline) {
    EXPECT_EQ(list_output("\n"), "\\n$\n");
}

TEST(DoList, EscapesBackslash) {
    EXPECT_EQ(list_output("\\"), "\\\\$\n");
}
...
TEST(DoSubst, NoMatch) {
    EXPECT_EQ(subst("x", "y", "hello"), "hello");
}
...
TEST(DoSubst, ReplaceFirst) {
    EXPECT_EQ(subst("a", "b", "aaa"), "baa");
}
